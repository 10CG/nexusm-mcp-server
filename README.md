...
**Known Wave 1 limitations**: (1) CI red until Wave 4 because `@nexusm/sdk@1.3.0` not yet published; (2) LICENSE file pending; (3) `schema_sync.test.ts` runtime check unblocks at Wave 4 SDK publish.
